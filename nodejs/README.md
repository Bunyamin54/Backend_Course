...
. Install Dependencies:  dotnet restore
 ...
 Install Entity Framework Tool::  dotnet tool install --global dotnet-ef
...
In your Program.cs file, explain the configuration processes and environment variables.
...
// ...
Açıklamalar
•	GetConnectionString: Veritabanı bağlantı dizgisini alır.
•	AddDbContext: DbContext'i DI konteynerine ekler.
•	UseSqlServer: SQL Server ile veritabanı etkileşimi için kullanılır.
•	LogTo: Loglama ayarlarını yapar.
